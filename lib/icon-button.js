...
export default function createIconButtonComponent(Icon) {
  return class IconButton extends Component {
    ...
    render() {
      const { style, iconStyle, touchStyle, children, ...restProps } = this.props;
      ...
      touchableStyle = touchStyle ? [styles.touchable, touchStyle] : styles.touchable;
      ...
      return (
        <TouchableHighlight
          style={[touchableStyle, blockStyle]}
          {...touchableProps}
        >
